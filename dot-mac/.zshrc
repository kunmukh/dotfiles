...
export ZSH="/Users/kunmukh/.oh-my-zsh"
...
plugins=(git)
plugins=(colored-man-pages colorize pip python brew osx zsh-syntax-highlighting zsh-autosuggestions)
...
export NVM_DIR="/Users/kunmukh/.nvm"
...
__conda_setup="$('/Users/kunmukh/opt/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
